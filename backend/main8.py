...
# Hardcoded Formula JSON
FORMULA_JSON = [
  {
    "LOB": "TW",
    "Segment": "1+5",
    "Insurer": "All Companies",
    "Formula": "90% of Payin",
    "Remarks": ""
  },
  {
  ...
  },
  {
    "LOB": "BUS",
    "Segment": "SCHOOL BUS",
    "Insurer": "TATA, Reliance, Digit, ICICI",
    "Formula": "Less 2 of Payin",
    "Remarks": ""
  },
  {
    "LOB": "BUS",
...
async def process_file(
    ...
    formula_file: UploadFile = File(...),  # Kept for API compatibility, but not used for formulas
    ...
    try:
        ...
        # Note: formula_file extraction is skipped; using hardcoded JSON instead
        # extracted_formula_text = await extract_text_from_file(formula_file, is_formula=True)  # Commented out
        ...
        # Use hardcoded JSON for formula rules
        formula_rules_json = json.dumps(FORMULA_JSON, indent=2)
        ...
        Formula Rules/Grid: {formula_rules_json}
        ...
        5. Fetch the corresponding 'Formula' and 'Remarks' from the Formula Rules/Grid JSON based on the matched LOB, Segment, Insurer, and Payin category
        6. Apply the fetched 'Formula' to calculate the Calculated Payout:
        ...
        - Use the 'Remarks' from the JSON if applicable, especially for special conditions
        ...
        - 'Formula Used' (the exact rule applied, fetched from the JSON)
